...
// /editor/new — asks for a workflow name and optional starter template.

import React, { useMemo, useState } from "react";
import { useRouter } from "next/navigation";
import { AlertCircle, ArrowRight, Boxes, Loader2, Play, Workflow } from "lucide-react";
...
export default function NewWorkflowPage() {
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-8 text-foreground">
      <form onSubmit={handleCreate} className="mx-auto flex w-full max-w-4xl flex-col gap-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="hidden h-9 items-center rounded-lg border border-border px-3 text-xs font-semibold text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:inline-flex"
          >
            Cancel
          </button>
        </div>
        ...
        <section>
          ...
          <div className="grid gap-3 md:grid-cols-4">
            <TemplateChoice
              ...
              description="Runnable starter: Manual Trigger into Jupiter Price API."
