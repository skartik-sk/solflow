        ...
        {result && (
          <div className="shrink-0 border-t border-border p-2">
            <button
              onClick={handleDownload}
              disabled={download.isFetching}
              className="w-full rounded border border-border bg-background px-2 py-1.5 text-xs text-foreground hover:bg-accent disabled:opacity-50 transition-colors"
            >
              {download.isFetching ? "Zipping…" : "Download ZIP"}
            </button>
          </div>
        )}
      </div>
