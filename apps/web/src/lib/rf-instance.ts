// apps/web/src/lib/rf-instance.ts
// Singleton holder for the React Flow instance.
// FlowCanvas writes it on init; any component can read it to call fitView/setCenter.
...
/** Pan + zoom to a specific node by ID. */
